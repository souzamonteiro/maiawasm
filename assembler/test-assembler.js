...
const TESTS = [
  ...
  ['negative i32 const literal',
    '(module (func $f (result i32) i32.const -16) (export "f" (func $f)))'],
  ['negative i64 const literal',
    '(module (func $f (result i64) i64.const -1) (export "f" (func $f)))'],
